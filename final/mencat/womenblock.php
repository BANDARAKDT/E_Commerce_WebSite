...
<html lang="en">
  ...
  <div class="menu-bar"> 
    ...
    <div>
    <h1><center>WOMENS</center></h1>
    <ul id="autoWidth" class="cs-hidden">
      <li class="item-a">
        <div class="box">
          <div class="slide-img">
            <a href="Men/shirts.html"><img src="women/b5.jpg" alt="" /></a>
            <div class="overlay">
          ...
          <div class="detail-box">
            <div class="type">
              <a href="women/blouses.html">TOPS</a>
              <span>Casual</span>
            </div>
      ...
      <li class="item-b">
        <div class="box">
          ...
          <div class="detail-box">
            <div class="type">
              <a href="women/sarees.html">SAREE</a>
              <span>decorated</span>
            </div>
            <a href="#" class="price"></a>
          </div>
      ...
      <li class="item-c">
        <div class="box">
          ...
          <div class="detail-box">
            <div class="type">
              <a href="women/index.html">FORCKS</a>
              <span> Casual</span>
            </div>
            <a href="#" class="price"></a>
          </div>
