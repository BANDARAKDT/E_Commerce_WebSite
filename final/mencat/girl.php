...
<html lang="en">
  ...
  <div class="menu-bar"> 
    ...
    <div>
    <h1><center>GIRLS</center></h1>
    <ul id="autoWidth" class="cs-hidden">
      <li class="item-a">
        <div class="box">
          <div class="slide-img">
            <a href="Men/shirts.html"><img src="Kids/Girls/Tops/t2.jpeg" alt="" /></a>
            <div class="overlay">
          ...
          <div class="detail-box">
            <div class="type">
              <a href="Kids/Girls/Tops/Tops.html">TOPS</a>
              <span>Casual</span>
            </div>
      ...
      <li class="item-b">
        <div class="box">
          <div class="slide-img">
            <img src="Kids/Girls/blouses/b3.jpg" alt="" />
            <div class="overlay">
               <!--<a href="#" class="buy-btn">Buy Now</a>-->
            </div>
          </div>
          <div class="detail-box">
            <div class="type">
              <a href="Kids/Girls/blouses/Nblouse.html">BLOUSES</a>
              <span>printed</span>
            </div>
            <a href="#" class="price"></a>
          </div>
      ...
      <li class="item-c">
        <div class="box">
          <div class="slide-img">
            <img src="Kids/Girls/frocks/f1.jpg" alt="" />
            <div class="overlay">
               <!--<a href="#" class="buy-btn">Buy Now</a>-->
            </div>
          </div>
          <div class="detail-box">
            <div class="type">
              <a href="Kids/Girls/frocks/Nfrock.html">FORCKS</a>
              <span> Casual</span>
            </div>
            <a href="#" class="price"></a>
          </div>
      ...
      <!--<li class="item-d">
        <div class="box">
          <div class="slide-img">
            <img src="photosformen/ws.jpg" alt="" />
            <div class="overlay">-->
               <!--<a href="#" class="buy-btn">Buy Now</a>-->
            <!--</div>
          </div>
