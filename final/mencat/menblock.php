...
<html lang="en">
  ...
  <div class="menu-bar"> 
    ...
    <div>
    <h1><center>MENS</center></h1>
    <ul id="autoWidth" class="cs-hidden">
      <li class="item-a">
        <div class="box">
          <div class="slide-img">
            <a href="Men/shirts.html"><img src="photosformen/s1.jpg" alt="" /></a>
            <div class="overlay">
      ...
      <li class="item-b">
        <div class="box">
          <div class="slide-img">
            <img src="photosformen/ts1.jpg" alt="" />
            <div class="overlay">
               <!--<a href="#" class="buy-btn">Buy Now</a>-->
            </div>
          </div>
          <div class="detail-box">
            <div class="type">
              <a href="Men/t_shirts.html">T-SHIRT</a>
      ...
      <li class="item-c">
        <div class="box">
          <div class="slide-img">
            <img src="photosformen/t1.jpg" alt="" />
            <div class="overlay">
               <!--<a href="#" class="buy-btn">Buy Now</a>-->
            </div>
          </div>
          <div class="detail-box">
            <div class="type">
              <a href="Men/trousers.html">TROUSER</a>
              <span>Formal and Casual</span>
            </div>
            <a href="#" class="price"></a>
          </div>
