      ...
      <li class="item-a">
        <div class="box">
          <div class="slide-img">
            <img src="s1.jpg" alt="" />
            <div class="overlay">
              <a href="../../../makeorder_men_shirt.php" class="buy-btn"  name="new_ld_top">Buy Now</a>
            </div>
          </div>
      ...
      <li class="item-c">
        <div class="box">
          ...
          <div class="detail-box">
            <div class="type">
              <a href="#">Linen</a>
              <span>CHINESE COLLAR SHIRT</span>
            </div>
