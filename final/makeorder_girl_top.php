            ...
            <!--<table border="0" name="itemdetails">
                <tr>-->
					...
					<select name="model" id="size">
                        <option value="girl_top_001">Lace Detailed Top</option>
                        <option value="girl_top_002">Long Indian Top</option>
                        <option value="girl_top_003">Short Printed Top</option>
                        <option value="girl_top_004">Lase Top</option>
                    </select><br><br>
