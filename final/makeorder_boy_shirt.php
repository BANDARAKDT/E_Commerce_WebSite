  ...
  content: "&#10006;";
            ...
            <!--<table border="0" name="itemdetails">
                <tr>-->
					...
					<select name="model" id="size">
                        <option value="boy_shirt_001">Boys Plaid Shirt</option>
                        <option value="boy_shirt_002">Boys Hoodie Shirt</option>
                        <option value="boy_shirt_003">Boys short sleeves shirt</option>
	...
	<?php
		...
		if(isset($_POST['next'])){
			...
			//select user id where email = user's email
            ...
            //select price of model user selected 
