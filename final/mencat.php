<html>
    ...
    <link rel="stylesheet" href="mencat/style.css" />
    <link rel="stylesheet" href="mencat/lightslider.css">
    <script type="text/javascript" src="mencat/jquery.js"></script>
    <script type="text/javascript" src="mencat/lightslider.js"></script>
...
<!--catalogs-->
    <div>
    <h1><center>~~ DRESSES ~~</center></h1>
    <ul id="autoWidth" class="cs-hidden">
      <li class="item-a">
        <div class="box">
          <div class="slide-img">
            <img src="/mencat/f1.jpg" alt="" />
            <div class="overlay">
    ...
    <script type="text/javascript" src="mencat/script.js"></script>
    </div>
